...
public:
    ...
    //Fixation du debut de la journee a 7h30, fin 19h, temps entre chaque cycle 2s , un cycle = 15min dans la simulation.
    Scheduler(Serveur& serv, double debut = 7.5, double fin = 19.0, int intervalle = 2000);

    //Fonction pour la Simualtion
    ...
    //Ecriture des logs dans le serveur
